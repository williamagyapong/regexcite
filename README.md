...
**NOTE: This is a toy package created by following the `The whole game`
example from the second edition of [R Packages](https://r-pkgs.org). It
...
devtools::install_github("williamagyapong/regexcite")
```
