...
**NOTE: This is a toy package created by following the [The whole game](https://r-pkgs.org/whole-game.html) example from the second edition of [R Packages](https://r-pkgs.org). It is not meant to actually be useful. If you want a package for factor handling, please see [stringr](https://stringr.tidyverse.org), [stringi](https://stringi.gagolewski.com/),
